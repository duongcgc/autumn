...
if ( ! function_exists( 'emoson_posted_on' ) ) {
	/**
...
if ( ! function_exists( 'emoson_posted_by' ) ) {
	/**
...
if ( ! function_exists( 'emoson_entry_meta_footer' ) ) {
	/**
	 ...
	 * @return void
	 */
	function emoson_entry_meta_footer() {
...
if ( ! function_exists( 'emoson_post_thumbnail' ) ) {
	/**
	 ...
	 * @return void
	 */
	function emoson_post_thumbnail() {
		if ( ! emoson_can_show_post_thumbnail() ) {
			return;
		}
		?>
...
if ( ! function_exists( 'emoson_the_posts_navigation' ) ) {
	/**
	 ...
	 * @return void
	 */
	function emoson_the_posts_navigation() {
