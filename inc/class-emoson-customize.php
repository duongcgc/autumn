...
if ( ! class_exists( 'Emoson_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Emoson 1.0
	 */
	class Emoson_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'emoson' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'emoson' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'emoson' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'emoson' ),
						'full'    => esc_html__( 'Full text', 'emoson' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-emoson-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'Emoson_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new Emoson_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'emoson' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
