	...
	wp.customize( 'background_color', function( value ) {
		value.bind( function( to ) {
			var lum = emosonGetHexLum( to ),
				...
				stylesheetID = 'emoson-customizer-inline-styles',
				stylesheet,
				styles;
			...
			if ( ! stylesheet.length ) {
				jQuery( '#emoson-style-inline-css' ).after( '<style id="' + stylesheetID + '"></style>' );
				stylesheet = jQuery( '#' + stylesheetID );
			}
