/* global emosonIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'emoson-supports-dark-theme' ) ) {
	emosonDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function emosonDarkModeEditorInit( attempt ) {
	...
	if ( emosonIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						emosonDarkModeEditorInit( attempt + 1 );
					},
